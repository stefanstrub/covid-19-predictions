...
class Data:
    def __init__(self, confirmedFile = None, deathsFile = None):
    ...
    def saveInDesiredFormat(self, confirmed_and_predicted, deaths_and_predicted, path2, path7, path30):
        ...
        t2_prediction = pd.DataFrame(data={'Province/State': np.nan, 'Country': self.countries,'Target/Date': self.x_date[len(self.df['date'])+n],'N': confirmed_and_predicted.iloc[:,len(self.date)+n], 'D': deaths_and_predicted.iloc[:,len(self.date)+n]})
        ...
        t7_prediction = pd.DataFrame(data={'Province/State': np.nan, 'Country': self.countries,'Target/Date': self.x_date[len(self.df['date'])+n],'N': confirmed_and_predicted.iloc[:,len(self.date)+n], 'D': deaths_and_predicted.iloc[:,len(self.date)+n]})
        print(t7_prediction)
        ...
        t30_prediction = pd.DataFrame(data={'Province/State': np.nan,'Country': self.countries,'Target/Date': self.x_date[len(self.df['date'])+n],'N': confirmed_and_predicted.iloc[:,len(self.date)+n], 'D': deaths_and_predicted.iloc[:,len(self.date)+n]})
...
class Prediction(Data):
    def __init__(self,confirmedFile,deathsFile):
        super(Prediction, self).__init__(confirmedFile, deathsFile)
    ...
    def setUpEverything(self, country, prediction_length = 30):
...
# =============================================================================
    ...
    def makePrediction(self, prediction_length = 30,CountryToInvestigate=None):
        self.prediction_length = int(prediction_length)
        confirmed_and_predicted = np.zeros((len(self.countries),len(self.date)+self.prediction_length))
        #self.countries = ['Switzerland']
...
# =============================================================================
#         fig = plt.figure()
#         plt.plot(self.x_date[:len(self.date)],self.confirmed,'.', label='data')
#         #plt.plot(x_date,y, label='fit')
#         plt.plot(self.x_date[len(self.date):len(self.date)+self.prediction_length],self.confirmed_and_predicted[i][len(self.date):],'.', label='prediction')
#         plt.xlabel('date')
#         plt.xticks( rotation='vertical')
...
# =============================================================================
#                 fig = plt.figure()
#                 plt.plot(self.x_date[1:len(s)+1],s,'.',label='s')
#                 plt.plot(self.x_date[1:len(self.new_deaths_averaged)+1],self.new_deaths_averaged,'.',label='new deaths averaged'+str(n)+str(mortality))
#                 plt.xlabel('date')
...
# =============================================================================
    ...
    def predict_deaths(self, country, prediction_length = 30, death_latency=9, mortality=0.054):
        self.setUpDeaths(country)
...
if __name__ == '__main__':
    ...
    newPrediction = Prediction(confirmedFile,deathsFile)
    ...
    path2 = r'C:\Users\stefa\OneDrive\Documents\Machine Learning\Covid-19 predictions\predictions'+r'\2day_prediction_'+newPrediction.x_date_str[len(newPrediction.df['date'])+2]+'.csv'
    path7 = r'C:\Users\stefa\OneDrive\Documents\Machine Learning\Covid-19 predictions\predictions'+r'\7day_prediction_'+newPrediction.x_date_str[len(newPrediction.df['date'])+7]+'.csv'
    path30 = r'C:\Users\stefa\OneDrive\Documents\Machine Learning\Covid-19 predictions\predictions'+r'\30day_prediction_'+newPrediction.x_date_str[len(newPrediction.df['date'])+30]+'.csv'
    
    newPrediction.saveInDesiredFormat(confirmed_and_predicted, deaths_and_predicted, path2, path7, path30)
